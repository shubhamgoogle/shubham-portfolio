          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16">
            ...
            <div className="bg-white rounded-2xl border border-gray-200 p-6 flex flex-col justify-between shadow-xs hover:border-[#FC6100]/40 hover:shadow-sm transition-all group">
              ...
              <div className="space-y-2">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-full inline-flex items-center justify-center gap-2 bg-amber-50 hover:bg-amber-100/80 text-amber-900 border border-amber-200/80 px-4 py-2 rounded-lg text-xs font-semibold transition-all"
                >
                  <GooglePhotosIcon className="w-3.5 h-3.5 text-[#FC6100]" />
                  <span>View Photos Album</span>
            ...
            <div className="bg-white rounded-2xl border border-gray-200 p-6 flex flex-col justify-between shadow-xs hover:border-[#DC2626]/40 hover:shadow-sm transition-all group">
              ...
              <div className="space-y-2">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-full inline-flex items-center justify-center gap-2 bg-red-50 hover:bg-red-100/80 text-red-900 border border-red-200/80 px-4 py-2 rounded-lg text-xs font-semibold transition-all"
                >
                  <GooglePhotosIcon className="w-3.5 h-3.5 text-[#DC2626]" />
                  <span>View Photos Album</span>
            ...
            <div className="bg-white rounded-2xl border border-gray-200 p-6 flex flex-col justify-between shadow-xs hover:border-[#81b64c]/50 hover:shadow-sm transition-all group">
              ...
              <div className="space-y-2">
                ...
                <div className="w-full inline-flex items-center justify-center gap-1.5 bg-gray-50 border border-gray-200 text-gray-600 px-4 py-2 rounded-lg text-xs font-medium">
                  <Crown className="w-3.5 h-3.5 text-[#629924]" />
                  <span>Tactical Mindset • Blitz &amp; Rapid</span>
                </div>
              </div>
            </div>
          </div>
